...
/* タスクテーブルのデータ*/
INSERT INTO  examreport (examreport_id,department,company_name_top,report_day,recruitment_number,company_name,application_route,exam_date_time,examination_location,contens_test ,remarks,Exam_report_status)
VALUES('0000000001','S','HCS','2020-07-09','0000000002','株式会社HCS','斡旋','2020-07-17','東京','1次試験','あんぱんまん','新規作成');